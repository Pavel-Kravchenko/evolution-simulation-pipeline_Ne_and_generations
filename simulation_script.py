...
tic = time()
# constants
length_of_sequence = 1000 #int(input("Type the length of sequence "))
fasta_line_const = 60
...
is_heteroplasmy = str(argv[4]) #str(input("Do you want to use the heteroplasmy model? [y]/[n] "))


if is_heteroplasmy == "y":
    out_file_name = "simulation_heteroplasmy|cycles_" + str(number_of_cycles) + "|species_" + str(number_of_species) + "|mutations_" + str(mutations_per_cycle) + ".fasta"
    heteroplasmy_species = number_of_species
if is_heteroplasmy == "n":
    out_file_name = "simulation|cycles_" + str(number_of_cycles) + "|species_" + str(number_of_species) + "|mutations_" + str(mutations_per_cycle) + ".fasta"
...
def seq_selection(in_dic, number_of_survived_species):
    ...
    if is_heteroplasmy == "y":
        ...
        random_seq = random.sample(list(dic), heteroplasmy_species)
        list_seq = []
